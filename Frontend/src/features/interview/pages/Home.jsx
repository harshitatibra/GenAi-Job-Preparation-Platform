        ...
        <div className="interview-card__body">
          ...
          <div className="panel panel--right">
            <div className="panel__header">
              ...
              <h2>
                {(user?.username || user?.email || "Your Profile").split(" ")[0] || "Your Profile"}
              </h2>
            </div>
            ...
            <div className="upload-section">
              ...
              {!selectedResume ? (
                ...
                <div className="uploaded-resume">
                  <div className="uploaded-resume__icon">📄</div>

                  <div className="uploaded-resume__info">
                    <p className="uploaded-resume__name">
                      {selectedResume.name}
                    </p>

                    <p className="uploaded-resume__size">
                  ...
                  <button
                    type="button"
                    className="button primary-button button--remove"
                    onClick={() => {
          ...
          <ul className="reports-list">
            {reports.map((report) => (
              ...
              >
                ...
                <button
                  className="delete-report-btn button primary-button button--remove"
                  onClick={async (e) => {
                    e.stopPropagation();
